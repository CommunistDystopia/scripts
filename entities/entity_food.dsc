    ...
    events:
        ...
        after player right clicks SHEEP|COW|CHICKEN|PIG|MUSHROOM_COW|RABBIT|HORSE|DONKEY|LLAMA with:NAME_TAG:
            - if <context.entity.has_flag[time_left]> && <context.entity.custom_name||null> != null && <context.item.has_display>:
                ...
                - determine cancelled
        after SHEEP|COW|CHICKEN|PIG|MUSHROOM_COW|RABBIT|HORSE|DONKEY|LLAMA spawns:
            - flag <context.entity> time_left:<util.time_now.to_utc.add[<script[Entity_Food_Data].data_key[time_left]>]>
            - adjust <context.entity> custom_name:<red>[<time[<context.entity.flag[time_left]>].duration_since[<util.time_now.to_utc>].in_hours.mul[100].div[24].round_to[0]><white><&chr[EFF1]><red>]
            ...
            - if <[world_animals]> != null:
                - foreach <[world_animals]> as:animal:
                    - if <[animal].has_flag[time_left]>:
                        - adjust <[animal]> custom_name:<red>[<time[<[animal].flag[time_left]>].duration_since[<util.time_now.to_utc>].in_hours.mul[100].div[24].round_to[0]><white><&chr[EFF1]><red>]<[animal].custom_name.after[]]>
