...
emerald_extractor:
    ...
    lore:
        ...
        - <gray>Default ratio: 64 <white>Iron<gray>/32 <white>Green Dye
...
ex_upgrade_1:
    ...
    lore:
        - <gray>Lower the ratio to: 32 <white>Iron<gray>/16 <white>Green Dye
...
ex_upgrade_2:
    ...
    lore:
        - <gray>Lower the ratio to: 16 <white>Iron<gray>/8 <white>Green Dye
        - <gray>Works with: <green>Emerald Extractor
...
ex_upgrade_3:
    ...
    lore:
        - <gray>Lower the ratio to: 8 <white>Iron<gray>/4 <white>Green Dye
        - <gray>Works with: <green>Emerald Extractor
...
ex_upgrade_4:
    ...
    lore:
        - <gray>Lower the ratio to: 4 <white>Iron<gray>/2 <white>Green Dye
        - <gray>Works with: <green>Emerald Extractor
...
ex_upgrade_5:
    ...
    lore:
        - <gray>Lower the ratio to: 2 <white>Iron<gray>/1 <white>Green Dye
        - <gray>Works with: <green>Emerald Extractor